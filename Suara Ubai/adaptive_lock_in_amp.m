...
% [d,Fs2]= audioread("Noise Orang_Edit.wav");
% [d,Fs2]= audioread("Noise Tukang_Edit.wav");
 [d,Fs2]= audioread("Noise Mobil_Edit.wav");
d = transpose(d(:,1));
...
filename = 'filtered_mobil_ubai.wav';
audiowrite(filename,e,Fs1);
filename = 'noise_expected_mobil_ubai.wav';
